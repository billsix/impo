#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Introduction to Python Programming into checkout/
...
PIN_SHA=d215dd3b99c33db855c49315152ebd5fbadc8534
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-introduction-python-programming.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-introduction-python-programming
