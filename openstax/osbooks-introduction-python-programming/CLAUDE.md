# osbooks-introduction-python-programming — OpenStax Introduction to Python Programming (imps)
...
`fetch.sh` pins **`d215dd3b99c33db855c49315152ebd5fbadc8534`** — the merge-base where the
...
`https://github.com/openstax/osbooks-introduction-python-programming`. Fallback mirror if GitHub is
unreachable: `pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-introduction-python-programming.git`.

## This book (from the survey; build-time facts pending)

- **Delta size:** 641 port-branch files; **has os-embed exercises (downloads)**
