# OpenStax Introduction to Python Programming — LaTeX port (imps)

A hand-owned LaTeX/PDF/EPUB/HTML port of OpenStax **Introduction to Python Programming**, built on pristine,
