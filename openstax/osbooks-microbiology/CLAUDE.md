# osbooks-microbiology — OpenStax Microbiology (imps)
...
`fetch.sh` pins **`ecf34dad129d686703780e87ab5aa2e59c577a6a`** — the merge-base where the
...
`https://github.com/openstax/osbooks-microbiology`. Fallback mirror if GitHub is
unreachable: `pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-microbiology.git`.
