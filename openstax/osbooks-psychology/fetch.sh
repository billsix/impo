#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Psychology 2e into checkout/
...
PIN_SHA=398f50856ca1df97b58cb778659212a1df572bbd
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-psychology.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-psychology
