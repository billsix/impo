#!/bin/bash
# Fetch the pinned, pristine OpenStax content for University Physics (bundle) into checkout/
...
PIN_SHA=a33cac5de6e771b213debf92265a1b14365ba46a
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-university-physics-bundle.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-university-physics-bundle
