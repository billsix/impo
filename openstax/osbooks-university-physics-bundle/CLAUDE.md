# osbooks-university-physics-bundle — OpenStax University Physics (bundle) (imps)
...
`fetch.sh` pins **`a33cac5de6e771b213debf92265a1b14365ba46a`** — the merge-base where the
...
`https://github.com/openstax/osbooks-university-physics-bundle`. Fallback mirror if GitHub is
unreachable: `pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-university-physics-bundle.git`.

## This book (from the survey; build-time facts pending)

- **Delta size:** 27 port-branch files; **no downloads (toolchain-only)**
