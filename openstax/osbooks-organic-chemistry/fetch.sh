#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Organic Chemistry into checkout/
...
PIN_SHA=2a1f82843a8b55cf0e185a3e0a295dd05c07c04e
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-organic-chemistry.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-organic-chemistry
