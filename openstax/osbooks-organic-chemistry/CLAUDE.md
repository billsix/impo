# osbooks-organic-chemistry — OpenStax Organic Chemistry (imps)
...
`fetch.sh` pins **`2a1f82843a8b55cf0e185a3e0a295dd05c07c04e`** — the merge-base where the
...
`https://github.com/openstax/osbooks-organic-chemistry`. Fallback mirror if GitHub is
unreachable: `pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-organic-chemistry.git`.

## This book (from the survey; build-time facts pending)

- **Delta size:** 4062 port-branch files; **has os-embed exercises (large: ~2076 jpg + 1959 json)**
