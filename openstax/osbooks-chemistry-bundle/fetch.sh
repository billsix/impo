#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Chemistry (bundle) into checkout/
...
PIN_SHA=dba91045bc6db7c7286ca63f3a4e92075ec31025
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-chemistry-bundle.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-chemistry-bundle
