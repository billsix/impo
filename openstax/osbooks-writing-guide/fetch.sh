#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Writing Guide into checkout/
...
PIN_SHA=7312ec11c4d7f95f2dc0565f9c52393903a4f677
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-writing-guide.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-writing-guide
