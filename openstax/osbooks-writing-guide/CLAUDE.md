# osbooks-writing-guide — OpenStax Writing Guide (imps)
...
`fetch.sh` pins **`7312ec11c4d7f95f2dc0565f9c52393903a4f677`** — the merge-base where the
...
`https://github.com/openstax/osbooks-writing-guide`. Fallback mirror if GitHub is
unreachable: `pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-writing-guide.git`.

## This book (from the survey; build-time facts pending)

- **Delta size:** 209 port-branch files; **some download content**
