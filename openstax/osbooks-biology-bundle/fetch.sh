#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Biology (bundle) into checkout/
...
PIN_SHA=1e74a23833550e6bbe3aa3450c50c9ecb74f3a66
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-biology-bundle.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-biology-bundle
