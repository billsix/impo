#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Calculus (bundle) into checkout/
...
PIN_SHA=9b6c28b21c723a10ac045bad22b34377b3ff3f89
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-calculus-bundle.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-calculus-bundle
