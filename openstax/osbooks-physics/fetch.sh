#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Physics into checkout/
...
PIN_SHA=cbf75cb4a18223a788868244be73affe932ef680
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-physics.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-physics
