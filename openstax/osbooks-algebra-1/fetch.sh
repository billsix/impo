#!/bin/bash
# Fetch the pinned, pristine OpenStax content for Algebra 1 into checkout/
...
PIN_SHA=332f78647098a60532a9833b8003dca5da7ff227
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-algebra-1.git)
# is the fallback if GitHub is ever unreachable.
UPSTREAM_URL=https://github.com/openstax/osbooks-algebra-1
