# osbooks-algebra-1 — OpenStax Algebra 1 (imps)
...
`fetch.sh` pins **`332f78647098a60532a9833b8003dca5da7ff227`** — the merge-base where the
...
`https://github.com/openstax/osbooks-algebra-1`. Fallback mirror if GitHub is
unreachable: `pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-algebra-1.git`.

## This book (from the survey; build-time facts pending)

- **Delta size:** 1268 port-branch files; **has os-embed exercises + SVG figures**
