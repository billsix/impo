#!/bin/bash
# Fetch the pinned, pristine OpenStax content for College Algebra (bundle) into checkout/
...
PIN_SHA=789b54099106b071d1d32bfcee454fed72eb4768
...
# (pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-college-algebra-bundle.git)
