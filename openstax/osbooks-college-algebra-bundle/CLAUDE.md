# osbooks-college-algebra-bundle — OpenStax College Algebra (bundle) (imps)
...
`fetch.sh` pins **`789b54099106b071d1d32bfcee454fed72eb4768`** — the merge-base where the
...
`https://github.com/openstax/osbooks-college-algebra-bundle`. Fallback mirror if GitHub is
unreachable: `pi@192.168.0.186:/mnt/usbdrive2/gitRepos/openstax/**/osbooks-college-algebra-bundle.git`.

## This book (from the survey; build-time facts pending)

- **Delta size:** 46 port-branch files; **small download cache**
